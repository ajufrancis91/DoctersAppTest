			...
			<div class="col-xs-12">
				...
				<div class="box box-primary">
					<div style="text-align:right; padding:10px;">
						<a class="add-user btn btn-success" title="Add"   href="<?php echo  base_url().'admin/Patient/add'; ?>">Add</a>
					</div>
					<form id="demo-form2" action="" enctype="multipart/form-data" method="post" data-parsley-validate class="form-horizontal form-label-left">					
							...
							<div class="box-body">
								...
								<?php
									...
									<td> '.$row['op_no'].'</td>
									<td> '.$row['contact'].'</td>
									<td ><a class="view-user btn btn-info" title="Patient Info" data-toggle="modal" href="'.base_url().'admin/Patient/info/'.$row['patient_id'] .'"   data-userid="ADMIN"><i class="fa fa-edit"></i></a>
									<a class="view-user btn btn-warning" title="Case Record" data-toggle="modal" href="'.base_url().'admin/Patient/caseRecord/'.$row['patient_id'] .'"   data-userid="ADMIN"><i class="fa fa-edit"></i></a>
									<a  class="delete-user btn btn-danger" title="Delete" data-toggle="modal" href="#" onClick="popupDelete(\''.$row['patient_id'].'\')" data-userid="ADMIN"><i class="fa fa-trash"></i></a>
									</td>
							   </tr>';?>
							   </tbody>
							  </table>
	...
	<div class="modal-dialog" role="document">
        <div class="modal-content">
			...
			<div class="modal-body">
				<form id="demo-form2" action="<?php echo  base_url().'admin/Patient/deletePatient'; ?>" method="post" data-parsley-validate class="form-horizontal form-label-left">
